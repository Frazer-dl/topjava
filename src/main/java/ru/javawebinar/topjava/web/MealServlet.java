...
public class MealServlet extends HttpServlet {
    ...
    public void init() {
        try (ConfigurableApplicationContext appCtx = new ClassPathXmlApplicationContext("spring/spring-app.xml")) {
            ...
            MealsUtil.meals.forEach(m -> restController.create(m, 1));
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        restController.create(meal, getUserId(request));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            case "delete":
                ...
                restController.delete(id, getUserId(request));
                response.sendRedirect(request.getContextPath()+ "/meals?userId=" + getUserId(request));
                break;
            case "create":
            case "update":
                final Meal meal = "create".equals(action) ?
                        ...
                        restController.get(getId(request), getUserId(request));
            ...
            default:
                ...
                request.setAttribute("userId", getUserId(request));
                request.setAttribute("meals", restController.getFiltered(getUserId(request), LocalDateTime.MIN, LocalDateTime.MAX, 2000));
