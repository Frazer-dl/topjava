...
public class MealTestData {
    ...
    public static final MatcherFactory.SimpleMatcher<MealTo> MEAL_TO_SIMPLE_MATCHER = MatcherFactory.simpleMatcher(MealTo.class);
    ...
    public static final List<MealTo> filteredMeals1 = List.of(mealTo6, mealTo5);
    public static final List<MealTo> filteredMeals2 = List.of(mealTo6, mealTo5, mealTo4);
    public static final List<MealTo> filteredMeals3 = List.of(mealTo3, mealTo2, mealTo1);
