...
public class MealTestData {
    ...
    public static final List<Meal> meals1 = List.of(meal7, meal6, meal5, meal4, meal3, meal2, meal1);
    public static final List<Meal> meals2 = List.of(adminMeal2, adminMeal1);
